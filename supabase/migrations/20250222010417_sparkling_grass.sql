/*
  # Add manifest management tables and functions
  ...
  2. Changes to order_legs
    - Add manifest_id column
    - Add estimated_margin column
    - Add actual_margin column
    - Add carrier_rate column
    - Add carrier_currency column
